...
func (r *CacheReconciler) Reconcile(req types.NamespacedName, resources *envoyv1alpha1.EnvoyResources, nodeID, version string) (ctrl.Result, error) {
...
func (r *CacheReconciler) GenerateSnapshot(req types.NamespacedName, resources *envoyv1alpha1.EnvoyResources, version string) (xdss.Snapshot, error) {
