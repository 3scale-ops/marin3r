...
type Resources struct {
	Clusters  []*envoy_config_cluster_v3.Cluster   `protobuf:"bytes,2,rep,name=clusters,json=clusters" json:"clusters"`
	Listeners []*envoy_config_listener_v3.Listener `protobuf:"bytes,4,rep,name=listeners,json=listeners" json:"listeners"`
}
